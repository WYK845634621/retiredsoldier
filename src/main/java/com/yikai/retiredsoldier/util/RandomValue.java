...
public class RandomValue {
    ...
    private static final String[] nationalitys = "中国,日本,韩国,牙买加,意大利,美国,新加坡,泰国,德国,瑞士,芬兰,比利时,埃及,加拿大,古巴,巴西瑞典,挪威,冰岛,丹麦,阿富汗,以色列".split(",");
    private static final String[] nations = "波士顿,新泽西,纽约,利物浦,牛津,格拉斯哥,巴黎,敦刻尔克,凡尔赛,温哥华,渥太华,莫雷利亚,坦皮科,圣路易斯波托西,莱昂,杜兰戈,圣加仑,北京,上海,深圳,苏黎世,日内瓦,釜山".split(",");
    ...
    /**
     * @Note: 获取国家
     * @Date:2019/3/30 9:25 @Auth:yikai.wang @Desc(V/B):〈〉
     */
    public static  String getNationality(){
        String nationality = nationalitys[(int) (Math.random()*nationalitys.length)];
        return nationality;
    }
    /**
     * @Note: 获取城市
     * @Date:2019/3/30 9:37 @Auth:yikai.wang @Desc(V/B):〈〉
     */
